...
class EnhancedSiteBuilder {
    ...
    async buildLocationPage(slug, locationData) {
        ...
        const sunTimes = this.sunCalc.getDetailedSunTimes(today, locationData.latitude, locationData.longitude);
        const dayLength = this.sunCalc.getDayLength(today, locationData.latitude, locationData.longitude);
        ...
        const pageData = {
            ...
            metaDescription: `Get today's sunrise and sunset times for ${locationData.name}, ${locationData.stateCode}. Sunrise: ${this.sunCalc.formatTime(sunTimes.sunrise, locationData.timezone)}, Sunset: ${this.sunCalc.formatTime(sunTimes.sunset, locationData.timezone)}. Photography tips and viewing spots included.`,
            ...
            // Current sun data
            currentDate: this.sunCalc.formatDate(today, locationData.timezone),
            sunriseTime: this.sunCalc.formatTime(sunTimes.sunrise, locationData.timezone),
            sunsetTime: this.sunCalc.formatTime(sunTimes.sunset, locationData.timezone),
